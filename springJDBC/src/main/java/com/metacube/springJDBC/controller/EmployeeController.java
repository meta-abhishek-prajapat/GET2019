...
import com.metacube.springJDBC.facade.FriendFacade;
...
public class EmployeeController {
	...
	public void profilePicture(HttpServletRequest request,Model model) throws Exception{
		...
		if(session.getAttribute("emp_id")!=null){
			...
			File file = new File("C:\\eclipseworkspace\\springJDBC\\src\\main\\webapp\\images\\"+session.getAttribute("emp_id").toString()+".jpg");
			if(file.exists()){
